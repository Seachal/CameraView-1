...
import com.otaliastudios.cameraview.demo.scanner.ScannerFinderView;
...
//        bundle.putParcelable(PictureFragment.ORIGIN_PICTURE, bitmap);
//        bundle.putParcelable(PictureFragment.CROP_PICTURE, bitmap);
